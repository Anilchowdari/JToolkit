...
char * err_m[] = {
	...
	/* 62 */ "Access file line overflow",
	/* 63 */ "Cache file line overflow",
	/* 64 */ "Malloc failed",
	/* 65 */ "Found URL encoded newline or return",
	...
	/* 91 */ "Gethostbyname can't resolve %s; ",
	...
	/* 96 */ "SECURITY Found bad character (%X hex) in CGI args",
	...
	/* 113 */ "Bad start or end byte in range request ",
	/* 114 */ "Malloc failed in mime_init",
	/* 115 */ "Attempt to serve a non-regular file",
    /* 116 */ "Problem creating or initializing new process",
    /* 117 */ "Pathway mode related error"
};
