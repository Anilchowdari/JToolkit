...
typedef struct  ReceiveInfo_Struct
{
        ...
        int             SyncId; /* Synchronization Id for this message. */
		//changed by babu
...
*/

          {
                ...
                int      Tag;    /* The break tag, established by SETPARAM 3. */
...
*/
            {
                ...
                int      Tag;    /* 'TagOrTimeout' value specified in the call */
                                /* to DeviceInfo2. */
...
*/
            {
                ...
                int MsgId;  /* Message system identifier for the message. */

                int Tag;    /* User tag for the message. */
...
*/
            {
                ...
                int Param2; /* The 'Param2' value supplied to LockMemory. */
...
*/
            {
                ...
                int      Tag;    /* The tag value supplied to 'NewProcessNoWait'. */
...
*/
            {
                ...
                int      System; /* System number containing the CPU. */
...
*/
            {
                ...
                int Tag;    /* The tag value supplied to 'Process_Create_'. */
...
*/
            {
                ...
                int Param2; /* The 'Param2' value supplied to SignalTimeout */
                                /* or SignalProcessTimeout. */
