...
/**
 * The <code>EchoServer</code> class contains code to test JPathway functionality.
 * This is a simple single-threaded echo server that does nothing with
 * any transaction IDs.  An echo server is a server
 * that replies with the same data that was sent to it and does not database work.
 */
public class EchoServer {

   /**
    * Constructs a EchoServer 
    */
   public EchoServer () {
      super();
   } /* end ctor */
